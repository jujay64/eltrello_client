...
import { Observable, Subject, filter, combineLatest, map, takeUntil } from 'rxjs';
...
import { TaskInputInterface } from 'src/app/shared/types/taskInputInterface';
...
export class BoardComponent implements OnInit, OnDestroy{
    ...
    initializeListeners(): void {
        ...
        .pipe(takeUntil(this.unsubscribe$))
        .subscribe((deletedColumnId) => {
            this.boardService.deleteColumn(deletedColumnId);
        });
        ...
        this.socketService.listen<string>(SocketEventsEnum.tasksDeleteSuccess).pipe(takeUntil(this.unsubscribe$)).subscribe((taskId) => {
